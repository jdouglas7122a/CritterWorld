...
namespace _100476935
{
    public class PopcornCompas : ICritterController
    {
        ...
        public PopcornCompasMap map = new PopcornCompasMap();

        public PopcornCompasMovment move = new PopcornCompasMovment();
        ...
        {
            string fileName = "PopcornCompas.cfg";
        ...
        public PopcornCompas(string name)
        {
            Name = name;
        }
        ...
        {
            PopcornCompasSettings settings = new PopcornCompasSettings(this);
            settings.Show();
            settings.Focus();
        }
